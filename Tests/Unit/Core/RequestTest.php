...
class RequestTest extends AbstractRequestBasedCase
{
    ...
    {
        $this->assertFalse($this->buildTestRequest('MyAliasedModel', 'HEAD')->isPreflight(), 'Failed isPreflight() for HEAD');
        $this->assertFalse($this->buildTestRequest('MyAliasedModel', 'GET')->isPreflight(), 'Failed isPreflight() for GET');

        $this->assertTrue($this->buildTestRequest('MyAliasedModel', 'OPTIONS')->isPreflight(), 'Failed isPreflight() for OPTIONS');

        $this->assertFalse($this->buildTestRequest('MyAliasedModel', 'POST')->isPreflight(), 'Failed isPreflight() for POST');
        $this->assertFalse($this->buildTestRequest('MyAliasedModel', 'PUT')->isPreflight(), 'Failed isPreflight() for PUT');
        $this->assertFalse($this->buildTestRequest('MyAliasedModel', 'PATCH')->isPreflight(), 'Failed isPreflight() for PATCH');
        $this->assertFalse($this->buildTestRequest('MyAliasedModel', 'DELETE')->isPreflight(), 'Failed isPreflight() for DELETE');
        $this->assertFalse($this->buildTestRequest('MyAliasedModel', 'TRACE')->isPreflight(), 'Failed isPreflight() for TRACE');
    }
    ...
    public function isWriteTest()
    {
        ...
        $this->assertFalse($this->buildTestRequest('MyAliasedModel', 'OPTIONS')->isWrite(), 'Failed isWrite() for OPTIONS');
        ...
        $this->assertTrue($this->buildTestRequest('MyAliasedModel', 'DELETE')->isWrite(), 'Failed isWrite() for DELETE');
    ...
    public function isReadTest()
    {
        ...
        $this->assertFalse($this->buildTestRequest('MyAliasedModel', 'OPTIONS')->isRead(), 'Failed isRead() for OPTIONS');
