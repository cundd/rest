 ...
 */
class CustomNullBackend implements PhpCapableBackendInterface, TaggableBackendInterface
{
    /**
     * @param array<mixed,mixed> $tags Tags to associate with this cache entry. If the backend does not support tags, this option can be ignored.
     */
    public function set(
